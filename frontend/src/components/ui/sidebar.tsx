      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            isDarkMode
              ? 'bg-gradient-to-l from-cyan-950 to-gray-900'
              : 'bg-gradient-to-l from-cyan-200/25 to-cyan-700/50',
            className,
          )}
          {...props}
        >
